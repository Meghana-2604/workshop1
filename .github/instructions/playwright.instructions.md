...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic, test constraints, or non-obvious interactions; do not narrate the next action.
...
- [ ] Code follows the repository TypeScript formatting conventions and comments explain intent rather than restating code
